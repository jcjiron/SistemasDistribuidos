 ...
 * 
 */
@WebServiceClient(name = "WsEmpleado", targetNamespace = "http://ws.ip.mc/", wsdlLocation = "http://localhost:8080/HibernateEmpleadoCRUD/WsEmpleado?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WSEMPLEADO_QNAME = new QName("http://ws.ip.mc/", "WsEmpleado");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/HibernateEmpleadoCRUD/WsEmpleado?wsdl");
    ...
    public WsEmpleado getWsEmpleadoPort() {
        return super.getPort(new QName("http://ws.ip.mc/", "WsEmpleadoPort"), WsEmpleado.class);
    }
    ...
    public WsEmpleado getWsEmpleadoPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.ip.mc/", "WsEmpleadoPort"), WsEmpleado.class, features);
    }
